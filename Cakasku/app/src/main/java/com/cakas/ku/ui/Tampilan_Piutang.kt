...
class Tampilan_Piutang : ComponentActivity() {
            ...
            CakaskuTheme {
                Scaffold(bottomBar = {
                    ...
                    Column(
                        ...
                        Image(
                            painterResource(R.drawable.title_piutang), "",
                            Modifier
                                .fillMaxWidth()
                                .height(44.dp)
                        )
                                ...
                                .clickable {
                                    if (rp.value.isEmpty()) {
                                        ...
                                        Toast
                                            .makeText(
                                                applicationContext,
                                                "Nama Piutang Tidak Boleh Kosong",
                                                Toast.LENGTH_LONG
                                            )
                                            .show()
                                        ...
                                        Toast
                                            .makeText(
                                                applicationContext,
                                                "Tanggal Piutang Tidak BoleH kOSONG",
                                                Toast.LENGTH_LONG
                                            )
                                            .show()
                                        ...
                                        Toast
                                            .makeText(
                                                applicationContext,
                                                "Tanggal Batas Piutang Tidak Boleh Kosong",
                                                Toast.LENGTH_LONG
                                            )
                                            .show()
                                    } else if (status.value.equals("Pilih Disini")) {
                                        Toast
                                            .makeText(
                                                applicationContext,
