...
class Tampilan_Pendapatan : ComponentActivity() {
            ...
            CakaskuTheme {
                Scaffold(bottomBar = {
                    ...
                    Column(
                        ...
                        Image(
                            painterResource(R.drawable.title_pendapatan), "",
                            Modifier
                                .fillMaxWidth()
                                .height(44.dp)
                        )
                        ...
                        Text(text = "Tanggal Pendapatan",modifier = Modifier
                            .absolutePadding(
                                top = 8.dp,
                                bottom = 10.dp,
                                left = 16.dp,
